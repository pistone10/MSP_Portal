...
class adLDAP {
    ...
    * @var string
    */   
    protected $accountSuffix = "@starfleet.local";
    ...
    * @var array
    */
    protected $domainControllers = array("svr-dc.starfleet.local");
    ...
    * @var string
    */
    protected $adminUsername = Enterprise;
    protected $adminPassword = CaptainJack21!;
