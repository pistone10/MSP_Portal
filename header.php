                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <form>
								<select name="clients">
									<option value="LITC">Leverage IT Consulting</option>
								</select>
							</form>
							<!-- Client Selector -->
                        </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> Office Layout</a>
                        </li>
                        <li>
						...
						<li>
                           <a href="#"><i class="fa fa-edit fa-fw"></i> Domain & DNS</a>
                        </li>
						<li>
                           <a href="#"><i class="fa fa-edit fa-fw"></i> Vendors</a>
                        </li>
						<li>
                           <a href="#"><i class="fa fa-edit fa-fw"></i> Passwords</a>
                        </li>
						<li>
                           <a href="#"><i class="fa fa-edit fa-fw"></i> Misc</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
